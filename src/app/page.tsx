...
export default function Home() {
  ...
  const testimonials = [
    {
      quote:
        "Jaagr has transformed the way I share my mental health journey. The community is incredibly supportive and engaging.",
      author: "Emily Chen",
      role: "Mental Health Advocate",
    },
    {
      quote:
        "As a therapist, I find Jaagr to be an invaluable resource for my clients. It provides a safe space for expression and growth.",
      author: "Dr. Michael Brown",
      role: "Clinical Psychologist",
    },
    {
      quote:
        "Jaagr has helped me understand my thoughts and emotions better. It's like having a supportive friend in your pocket.",
      ...
      <main className="flex-1">
        ...
        <section className="bg-accent py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            />
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Our prevention mission is about looking for the root causes of
