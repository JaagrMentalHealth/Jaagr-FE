...
import { ArrowRight, Info, Lock, Shield } from "lucide-react"
import MentalHealthAssessment from "../assessments/page"
...
export default function InstructionPage() {
  ...
  if (startAssessment) {
    return <MentalHealthAssessment userData={userData} />
  }
    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-purple-50 to-white flex items-center justify-center p-4 sm:p-6 md:p-8">
      <Card className="w-full max-w-2xl mx-auto overflow-hidden shadow-lg border-purple-100">
        <CardHeader className="bg-purple-600 text-white p-6">
          <CardTitle className="text-2xl font-bold">Mental Health Assessment</CardTitle>
          <p className="text-purple-100 mt-2">
            Complete this brief assessment to help us understand your mental wellbeing
          </p>
        </CardHeader>

        <CardContent className="p-6 space-y-6">
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-purple-900">Welcome to Your Assessment</h2>

            <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
              <div className="flex items-start gap-3">
                <Info className="h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
                <div className="space-y-2">
                  <h3 className="font-medium text-purple-900">Before You Begin</h3>
          ...
          <div className="flex items-start space-x-2 pt-4 border-t border-purple-100">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-purple-600">
                ...
                . You acknowledge that this is not a diagnostic tool and does not replace professional medical advice.
              </p>
            </div>
          </div>
        </CardContent>
